...
class ToastContainer extends Component {
    ...
    constructor() {
        ...
        this.state = {
            ...
            keyboardScreenY: this.props.mountOffset ? this.props.mountOffset : window.height
        };
    }
    ...
    componentWillMount() {
        ...
        if (this.props.keyboardAvoiding) {
            ...
            Keyboard.addListener('keyboardDidShow', this._keyboardDidChangeFrame);
            Keyboard.addListener('keyboardDidHide', this._keyboardDidChangeFrame);
        }
    }
    ...
    componentWillUnmount = () => {
        ...
        Keyboard.removeListener('keyboardDidShow', this._keyboardDidChangeFrame);
        Keyboard.removeListener('keyboardDidHide', this._keyboardDidChangeFrame);
    };
